...
def test_space_must_have_positive_price():
    ...
    with pytest.raises(ValueError, match="Price must be above 0"):
        Space(1, 1, "The Oasis", "Enjoy views of the beach", 0)
